(()=>{
'use strict';
const keys={bridge:'careerLabBridgeV2',keyword:'careerLabKeywordV1',inquiry:'careerLabInquiryV1',roadmap:'careerLabRoadmapV1',mode:'careerLabStorageModeV1'};
...
function nav(active){return `<nav class="flow-nav no-print" aria-label="학생 성장 로드맵"><a href="index.html" ${active==='career'?'aria-current="page"':''}>STEP 0 진로 가설</a><a href="keyword.html" ${active==='keyword'?'aria-current="page"':''}>STEP 1 질문 만들기</a><a href="inquiry.html" ${active==='inquiry'?'aria-current="page"':''}>STEP 2 탐구 설계</a><a href="roadmap.html" ${active==='roadmap'?'aria-current="page"':''}>STEP 3 성장 로드맵</a></nav>`}
